...
Matplotlib
Project Structure
├── dataset/ │ ├── raw_videos/ │ ├── extracted_landmarks/ ├── model/ │ ├── lstm_model.py ├── utils/ │ ├── mediapipe_utils.py │ ├── preprocessing.py ├── train.py ├── predict.py ├── app.py # For real-time inference ├── README.md
